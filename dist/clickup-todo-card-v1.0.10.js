...
`;console.info("%c  CLICKUP-TODO-CARD  \n%c  Version 1.0.0  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"custom:clickup-todo-card",name:"ClickUp Todo Card",description:"Enhanced todo card with ClickUp custom fields and filters",preview:!0,documentationURL:"https://github.com/chbarnhouse/clickup-todo-card"});let Ct=class extends nt{constructor(){super(...arguments),this._config={type:"custom:clickup-todo-card",entity:"",...yt},this._tasks=[]}static async getConfigElement(){return await Promise.resolve().then(function(){return St}),document.createElement("clickup-todo-card-editor")}static getStubConfig(){return{type:"custom:clickup-todo-card",entity:"",...yt}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={...yt,...t}}getCardSize(){return 3+(this._tasks?.length||0)}shouldUpdate(t){if(!this._config||!this.hass)return!0;if(!this._config.entity)return!0;try{return function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var s=e.get("hass");return!s||s.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}catch(t){return console.error("Error in shouldUpdate:",t),!0}}render(){try{if(!this._config||!this.hass)return I`<ha-card><div class="warning">Loading...</div></ha-card>`;if(!this._config.entity)return I`
    ...
    `}async _toggleTask(t){const e="completed"===t.status?"needs_action":"completed";try{await this.hass.callService("todo","update_item",{entity_id:this._config.entity,item:t.uid,status:e})}catch(t){console.error("Error toggling task:",t)}}static get styles(){return At}};t([ut({attribute:!1})],Ct.prototype,"hass",void 0),t([pt()],Ct.prototype,"_config",void 0),t([pt()],Ct.prototype,"_tasks",void 0),Ct=t([lt("clickup-todo-card")],Ct);let Et=class extends nt{constructor(){super(),this._config={type:"custom:clickup-todo-card",entity:""},this._tasks=[],console.log("ClickUp Card Editor: Constructor called")}connectedCallback(){super.connectedCallback(),console.log("ClickUp Card Editor: Connected to DOM")}setConfig(t){this._config={type:"custom:clickup-todo-card",entity:"",...t},this._loadEntityData()}_loadEntityData(){if(!this.hass||!this._config.entity)return;const t=this.hass.states[this._config.entity];t&&(this._tasks=$t(t))}render(){try{if(!this.hass)return I`<div>Loading hass...</div>`;if(!this._config)return I`<div>Loading config...</div>`;const t=this.hass.states||{},e=Object.keys(t).filter(t=>t.startsWith("todo.")).sort();console.log("ClickUp Card Editor: Found",e.length,"todo entities");const i=this._tasks.length>0?function(t){const e=new Map;return t.forEach(t=>{t.clickup_status?.status&&e.set(t.clickup_status.status,t.clickup_status.status)}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks):[],s=this._tasks.length>0?function(t){const e=new Set;return t.forEach(t=>{t.tags?.forEach(t=>{t.name&&e.add(t.name)})}),Array.from(e).map(t=>({value:t,label:t})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks):[],r=this._tasks.length>0?function(t){const e=new Map;return t.forEach(t=>{t.assignees?.forEach(t=>{t.id&&t.username&&e.set(t.id.toString(),t.username)})}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks):[],o=this._tasks.length>0?function(t){const e=new Map;return t.forEach(t=>{t.custom_fields?.forEach(t=>{t.id&&t.name&&e.set(t.id,t.name)})}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks):[];return I`
      <div class="card-config">
        <!-- Basic Settings -->
        <div class="config-section">
          <h3>Basic Settings</h3>

          <p style="color: lime;">DEBUG: Editor loaded. Found ${e.length} todo entities</p>

          <ha-textfield
            label="Entity (required)"
            .value=${this._config.entity||""}
            @input=${t=>this._entityChanged(t.target.value)}
            helperText="Enter todo entity ID (e.g., todo.clickup_workspace_my_tasks)"
          ></ha-textfield>

          ${e.length>0?I`
            <p style="font-size: 12px; color: var(--secondary-text-color); margin-top: -8px;">
              Available entities: ${e.join(", ")}
            </p>
          `:""}
        ...
        ${this._config.show_custom_fields&&o.length>0?I`
          <div class="config-section">
        ...
        <div class="config-section">
          ...
          ${"custom_field"===this._config.group_by&&o.length>0?I`
            <ha-select
    ...
    `}catch(t){return console.error("Error rendering ClickUp Todo Card editor:",t),I`
      ...
      `}}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i=e.configValue;if(!i)return;let s;if(void 0!==e.checked)s=e.checked;else{if(void 0===e.value)return;s=e.value}""===s&&(s=void 0);const r={...this._config,[i]:s};"entity"===i&&setTimeout(()=>this._loadEntityData(),100),mt(this,"config-changed",{config:r})}_entityChanged(t){if(!this._config||t===this._config.entity)return;const e={...this._config,entity:t};this._config=e,this._loadEntityData(),mt(this,"config-changed",{config:e})}_isFieldVisible(t){return!(!this._config.visible_custom_fields||0===this._config.visible_custom_fields.length)&&this._config.visible_custom_fields.includes(t)}_customFieldChanged(t){const e=t.target,i=e.value,s=e.checked,r=this._config.visible_custom_fields||[];let o;o=s?[...r,i]:r.filter(t=>t!==i);const a={...this._config,visible_custom_fields:o.length>0?o:void 0};mt(this,"config-changed",{config:a})}_isStatusFiltered(t){return this._config.filters?.status?.includes(t)||!1}_statusFilterChanged(t){const e=t.target,i=e.value,s=e.checked,r=this._config.filters||{},o=r.status||[];let a;a=s?[...o,i]:o.filter(t=>t!==i);const n={...this._config,filters:{...r,status:a.length>0?a:void 0}};mt(this,"config-changed",{config:n})}_isPriorityFiltered(t){return this._config.filters?.priority?.includes(t)||!1}_priorityFilterChanged(t){const e=t.target,i=e.value,s="null"===i?null:parseInt(i),r=e.checked,o=this._config.filters||{},a=o.priority||[];let n;n=r?[...a,s]:a.filter(t=>t!==s);const c={...this._config,filters:{...o,priority:n.length>0?n:void 0}};mt(this,"config-changed",{config:c})}_isTagFiltered(t){return this._config.filters?.tags?.includes(t)||!1}_tagFilterChanged(t){const e=t.target,i=e.value,s=e.checked,r=this._config.filters||{},o=r.tags||[];let a;a=s?[...o,i]:o.filter(t=>t!==i);const n={...this._config,filters:{...r,tags:a.length>0?a:void 0}};mt(this,"config-changed",{config:n})}_isAssigneeFiltered(t){return this._config.filters?.assignees?.includes(t)||!1}_assigneeFilterChanged(t){const e=t.target,i=e.value,s=e.checked,r=this._config.filters||{},o=r.assignees||[];let a;a=s?[...o,i]:o.filter(t=>t!==i);const n={...this._config,filters:{...r,assignees:a.length>0?a:void 0}};mt(this,"config-changed",{config:n})}_dateRangeChanged(t,e){const i=this._config.filters||{},s={...i.due_date_range||{},[t]:e||void 0},r=s.start||s.end,o={...this._config,filters:{...i,due_date_range:r?s:void 0}};mt(this,"config-changed",{config:o})}static get styles(){return a`
      .card-config {
        padding: 16px;
      }
