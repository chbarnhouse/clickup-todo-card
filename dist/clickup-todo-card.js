      ...
      <div class="card-config">
        ...
        <div class="config-section">
          ...
          <ha-select
            ...
            @selected=${t=>this._updateConfig("add_button_position",t.detail.value)}
          >
        ...
        <div class="config-section">
          ...
          <ha-select
            ...
            @closed=${t=>{console.log("Sort By @closed event fired:",t);const e=t.target;console.log("Target:",e),console.log("Target value:",e.value),e.value&&e.value!==this._config.sort_by&&this._updateConfig("sort_by",e.value)}}
          >
          ...
          <ha-select
            ...
            @selected=${t=>this._updateConfig("sort_order",t.detail.value)}
          >
        ...
        <div class="config-section">
          ...
          <ha-select
            ...
            @selected=${t=>this._updateConfig("group_by",t.detail.value)}
          >
          ...
          ${"custom_field"===this._config.group_by&&s.length>0?V`
            <ha-select
              ...
              @selected=${t=>this._updateConfig("group_field_id",t.detail.value)}
            >
              ${s.map(t=>V`
