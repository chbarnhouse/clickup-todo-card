  ...
  `}render(){return j`
    ...
    `:j`
      ...
      >
        ...
        ${a?j`
          <div class="task-status-pill" style="background: ${t.clickup_status?.color||"var(--disabled-text-color)"}">
            <ha-checkbox
              .checked=${i}
