...
`;console.info("%c  CLICKUP-TODO-CARD  \n%c  Version 1.0.0  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"custom:clickup-todo-card",name:"ClickUp Todo Card",description:"Enhanced todo card with ClickUp custom fields and filters",preview:!0,documentationURL:"https://github.com/chbarnhouse/clickup-todo-card"});let Ct=class extends nt{constructor(){super(...arguments),this._config={type:"custom:clickup-todo-card",entity:"",...$t},this._tasks=[]}static async getConfigElement(){return await Promise.resolve().then(function(){return Et}),document.createElement("clickup-todo-card-editor")}static getStubConfig(){return{type:"custom:clickup-todo-card",entity:"",...$t}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={...$t,...t}}getCardSize(){return 3+(this._tasks?.length||0)}shouldUpdate(t){return!!this._config&&function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var s=e.get("hass");return!s||s.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}render(){if(!this._config||!this.hass)return I``;if(!this._config.entity)return I`
        <ha-card>
      ...
      `;this._tasks=yt(t);const e=xt(bt(function(t,e){let i=[...t];if(!e.filters)return i;if(e.filters.status?.length&&(i=i.filter(t=>{const i=t.clickup_status?.status;return i&&e.filters.status.includes(i)})),e.filters.priority?.length&&(i=i.filter(t=>{const i=null===t.priority?null:t.priority;return e.filters.priority.includes(i)})),e.filters.tags?.length&&(i=i.filter(t=>!!t.tags?.length&&t.tags.some(t=>e.filters.tags.includes(t.name)))),e.filters.assignees?.length&&(i=i.filter(t=>!!t.assignees?.length&&t.assignees.some(t=>e.filters.assignees.includes(t.id.toString())))),e.filters.due_date_range){const{start:t,end:s}=e.filters.due_date_range;i=i.filter(e=>{if(!e.due)return!1;const i=new Date(e.due).getTime();return!(t&&i<new Date(t).getTime())&&!(s&&i>new Date(s).getTime())})}return i}(this._tasks,this._config),this._config),this._config.group_by||"none",this._config.group_field_id);return I`
      <ha-card>
        ${this._renderHeader(t)}
        <div class="card-content ${this._config.compact_mode?"compact":""}">
          ${1===e.size&&e.has("all")?this._renderTaskList(e.get("all")):this._renderGroupedTasks(e)}
        </div>
      </ha-card>
    ...
    `}async _toggleTask(t){const e="completed"===t.status?"needs_action":"completed";try{await this.hass.callService("todo","update_item",{entity_id:this._config.entity,item:t.uid,status:e})}catch(t){console.error("Error toggling task:",t)}}static get styles(){return At}};t([ut({attribute:!1})],Ct.prototype,"hass",void 0),t([pt()],Ct.prototype,"_config",void 0),t([pt()],Ct.prototype,"_tasks",void 0),Ct=t([lt("clickup-todo-card")],Ct);let St=class extends nt{constructor(){super(...arguments),this._config={type:"custom:clickup-todo-card",entity:""},this._tasks=[]}setConfig(t){this._config={type:"custom:clickup-todo-card",entity:"",...t},this._loadEntityData()}_loadEntityData(){if(!this.hass||!this._config.entity)return;const t=this.hass.states[this._config.entity];t&&(this._tasks=yt(t))}render(){if(!this.hass)return I`<div>Loading...</div>`;if(!this._config)return I`<div>No configuration</div>`;Object.keys(this.hass.states).filter(t=>t.startsWith("todo."));const t=function(t){const e=new Map;return t.forEach(t=>{t.clickup_status?.status&&e.set(t.clickup_status.status,t.clickup_status.status)}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks),e=function(t){const e=new Set;return t.forEach(t=>{t.tags?.forEach(t=>{t.name&&e.add(t.name)})}),Array.from(e).map(t=>({value:t,label:t})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks),i=function(t){const e=new Map;return t.forEach(t=>{t.assignees?.forEach(t=>{t.id&&t.username&&e.set(t.id.toString(),t.username)})}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks),s=function(t){const e=new Map;return t.forEach(t=>{t.custom_fields?.forEach(t=>{t.id&&t.name&&e.set(t.id,t.name)})}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks);return I`
      <div class="card-config">
        ...
        ${this._config.show_custom_fields&&s.length>0?I`
          <div class="config-section">
        ...
        <div class="config-section">
          ...
          ${"custom_field"===this._config.group_by&&s.length>0?I`
            <ha-select
    ...
    `}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i=e.configValue;if(!i)return;let s;if(void 0!==e.checked)s=e.checked;else{if(void 0===e.value)return;s=e.value}""===s&&(s=void 0);const a={...this._config,[i]:s};"entity"===i&&setTimeout(()=>this._loadEntityData(),100),mt(this,"config-changed",{config:a})}_entityChanged(t){if(!this._config||t===this._config.entity)return;const e={...this._config,entity:t};this._config=e,this._loadEntityData(),mt(this,"config-changed",{config:e})}_isFieldVisible(t){return!(!this._config.visible_custom_fields||0===this._config.visible_custom_fields.length)&&this._config.visible_custom_fields.includes(t)}_customFieldChanged(t){const e=t.target,i=e.value,s=e.checked,a=this._config.visible_custom_fields||[];let r;r=s?[...a,i]:a.filter(t=>t!==i);const o={...this._config,visible_custom_fields:r.length>0?r:void 0};mt(this,"config-changed",{config:o})}_isStatusFiltered(t){return this._config.filters?.status?.includes(t)||!1}_statusFilterChanged(t){const e=t.target,i=e.value,s=e.checked,a=this._config.filters||{},r=a.status||[];let o;o=s?[...r,i]:r.filter(t=>t!==i);const n={...this._config,filters:{...a,status:o.length>0?o:void 0}};mt(this,"config-changed",{config:n})}_isPriorityFiltered(t){return this._config.filters?.priority?.includes(t)||!1}_priorityFilterChanged(t){const e=t.target,i=e.value,s="null"===i?null:parseInt(i),a=e.checked,r=this._config.filters||{},o=r.priority||[];let n;n=a?[...o,s]:o.filter(t=>t!==s);const c={...this._config,filters:{...r,priority:n.length>0?n:void 0}};mt(this,"config-changed",{config:c})}_isTagFiltered(t){return this._config.filters?.tags?.includes(t)||!1}_tagFilterChanged(t){const e=t.target,i=e.value,s=e.checked,a=this._config.filters||{},r=a.tags||[];let o;o=s?[...r,i]:r.filter(t=>t!==i);const n={...this._config,filters:{...a,tags:o.length>0?o:void 0}};mt(this,"config-changed",{config:n})}_isAssigneeFiltered(t){return this._config.filters?.assignees?.includes(t)||!1}_assigneeFilterChanged(t){const e=t.target,i=e.value,s=e.checked,a=this._config.filters||{},r=a.assignees||[];let o;o=s?[...r,i]:r.filter(t=>t!==i);const n={...this._config,filters:{...a,assignees:o.length>0?o:void 0}};mt(this,"config-changed",{config:n})}_dateRangeChanged(t,e){const i=this._config.filters||{},s={...i.due_date_range||{},[t]:e||void 0},a=s.start||s.end,r={...this._config,filters:{...i,due_date_range:a?s:void 0}};mt(this,"config-changed",{config:r})}static get styles(){return o`
      .card-config {
        padding: 16px;
      }
    ...
    `}};t([ut({attribute:!1})],St.prototype,"hass",void 0),t([pt()],St.prototype,"_config",void 0),t([pt()],St.prototype,"_tasks",void 0),t([pt()],St.prototype,"_helpers",void 0),St=t([lt("clickup-todo-card-editor")],St);var Et=Object.freeze({__proto__:null,get ClickUpTodoCardEditor(){return St}});export{Ct as ClickUpTodoCard};
