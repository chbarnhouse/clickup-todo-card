...
`;async function Ft(t,e,i){try{return e.clickup_id?(await t.callService("clickup","update_task_status",{task_id:e.clickup_id,status:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task status:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}let Ot=class extends nt{constructor(){super(...arguments),this.value="",this.editing=!1,this.placeholder="Click to edit",this.required=!1,this.multiline=!1,this._tempValue="",this._error=""}static{this.styles=r`
    :host {
      display: block;
      position: relative;
    }
  ...
  `}render(){return B`
    ...
    `}_renderDisplay(){const t=Pt.find(t=>t.value===this.value)||Pt[4];return B`
      <div
    ...
    `}_toggleDropdown(){this._isOpen=!this._isOpen,this._isOpen&&setTimeout(()=>{const t=e=>{this.shadowRoot?.contains(e.target)||(this._isOpen=!1,document.removeEventListener("click",t))};document.addEventListener("click",t)},0)}_selectPriority(t){const e=this.value;e!==t&&(this.value=t,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,oldValue:e},bubbles:!0,composed:!0}))),this._isOpen=!1}connectedCallback(){super.connectedCallback(),this._handleKeyDown=this._handleKeyDown.bind(this),document.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._handleKeyDown)}_handleKeyDown(t){"Escape"===t.key&&this._isOpen&&(this._isOpen=!1)}};t([pt({type:Number})],It.prototype,"value",void 0),t([pt({type:Boolean})],It.prototype,"showLabel",void 0),t([pt({type:Boolean})],It.prototype,"compact",void 0),t([ut()],It.prototype,"_isOpen",void 0),It=t([ct("editable-priority")],It);let Mt=class extends nt{constructor(){super(...arguments),this.value=null,this.label="Date",this.icon="mdi:calendar",this.compact=!1,this.allowNull=!0,this.dateType="due",this._editing=!1,this._tempValue=""}static{this.styles=r`
    :host {
      display: inline-block;
      position: relative;
    }
  ...
  `}render(){return B`
    ...
    `}_openDialog(){this._isOpen=!0}_closeDialog(){this._isOpen=!1}_selectStatus(t){const e=this.value;(e?.name||e?.status||"")!==(t.name||t.status||"")&&(this.value=t,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,oldValue:e},bubbles:!0,composed:!0}))),this._isOpen=!1}};t([pt({type:Object})],Lt.prototype,"value",void 0),t([pt({type:Array})],Lt.prototype,"options",void 0),t([pt({type:Boolean})],Lt.prototype,"compact",void 0),t([ut()],Lt.prototype,"_isOpen",void 0),Lt=t([ct("editable-status")],Lt),console.info("%c  CLICKUP-TODO-CARD  \n%c  Version 2.14.0  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");class Vt extends nt{constructor(){super(...arguments),this._config={type:"custom:clickup-todo-card",entity:"",...yt},this._tasks=[],this._displayedTasks=[],this._editingTask=null,this._showAddDialog=!1,this._selectedTasks=new Set,this._selectionMode=!1,this._draggedTask=null,this._dragOverTask=null}get config(){return this._config}static async getConfigElement(){return await Promise.resolve().then(function(){return jt}),document.createElement("clickup-todo-card-editor")}static getStubConfig(){return{type:"custom:clickup-todo-card",entity:"",...yt}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={...yt,...t}}getCardSize(){return 3+(this._tasks?.length||0)}shouldUpdate(t){if(!this._config||!this.hass)return!0;if(!this._config.entity)return!0;try{return function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var a=e.get("hass");return!a||a.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}catch(t){return console.error("Error in shouldUpdate:",t),!0}}_calculatePillWidth(t){if(!this._config.show_status||!t||0===t.length)return 100;let e="";for(const i of t)if(i.clickup_status?.status){const t=i.clickup_status.status;t.length>e.length&&(e=t)}if(!e)return 100;const i=this._config.compact_mode,a=1*(i?11:12),s=i?.4:.5;return 4+(i?14:16)+0+Math.ceil(e.length*a+e.length*s+8)}render(){try{if(!this._config||!this.hass)return B`<ha-card><div class="warning">Loading...</div></ha-card>`;if(!this._config.entity)return B`
          <ha-card>
        ...
        `;this._tasks=kt(t);let e=this._tasks;if("custom"===this._config.sort_by){const t=function(t){try{const e=Dt(t),i=localStorage.getItem(e);return i?JSON.parse(i):null}catch(t){return console.error("Error loading custom order:",t),null}}(this._config.entity);t&&(e=function(t,e){const i=new Map(t.map(t=>[t.uid,t])),a=[],s=new Set;for(const t of e){const e=i.get(t);e&&(a.push(e),s.add(t))}for(const e of t)s.has(e.uid)||a.push(e);return a}(this._tasks,t))}const i=wt(function(t,e){let i=[...t];if(!e.filters)return i;if(e.filters.status?.length&&(i=i.filter(t=>{const i=t.clickup_status?.status;return i&&e.filters.status.includes(i)})),e.filters.priority?.length&&(i=i.filter(t=>{const i=null===t.priority?null:t.priority;return e.filters.priority.includes(i)})),e.filters.tags?.length&&(i=i.filter(t=>!!t.tags?.length&&t.tags.some(t=>e.filters.tags.includes(t.name)))),e.filters.assignees?.length&&(i=i.filter(t=>!!t.assignees?.length&&t.assignees.some(t=>e.filters.assignees.includes(t.id.toString())))),e.filters.due_date_range){const{start:t,end:a}=e.filters.due_date_range;i=i.filter(e=>{if(!e.due)return!1;const i=new Date(e.due).getTime();return!(t&&i<new Date(t).getTime())&&!(a&&i>new Date(a).getTime())})}return i}(e,this._config),this._config);this._displayedTasks=i;const a=this._calculatePillWidth(i),s=Ct(i,this._config.group_by||"none",this._config.group_field_id),o=!1!==this._config.add_button_overlay,r=this._config.add_button_position||"bottom-right",n=!o&&r.startsWith("top"),l=!o&&r.startsWith("bottom");return B`
        <ha-card>
    ...
    `}_renderPriority(t){if(!this._config.show_priority||null===t.priority||void 0===t.priority)return B``;const e=t.priority,i=this._config.field_icons?.priority,a=i||vt[e]||vt.null,s=bt[e]||bt.null,o=this._config.field_styles?.priority||"";return B`
      <ha-icon
        class="priority-icon"
        icon="${a}"
        style="color: ${s}; ${o}"
      ></ha-icon>
    `}_renderDates(t){const e=this._config.show_start_date&&t.start_date,i=this._config.show_due_date&&t.due;if(!e&&!i)return B``;const a=this._config.field_icons?.start_date,s=a||"mdi:calendar-start",o=this._config.field_styles?.start_date||"",r=this._config.field_icons?.due_date,n=r||"mdi:calendar-end",l=this._config.field_styles?.due_date||"",c=this._config.field_styles?.dates||"";return B`
      <div class="task-dates" style="${c}">
        ...
        ${i?B`
          <span class="date-item due-date ${Et(t.due)}" style="${l}">
            <ha-icon icon="${n}"></ha-icon>
            ${Tt(t.due)}
          </span>
        `:""}
      </div>
    `}_renderTags(t){if(!this._config.show_tags||!t.tags||0===t.tags.length)return B``;const e=this._config.field_styles?.tags||"";return B`
    ...
    `}_renderAssignees(t){if(!this._config.show_assignees||!t.assignees||0===t.assignees.length)return B``;const e=this._config.field_styles?.assignees||"";return B`
      <div class="task-assignees" style="${e}">
        ${t.assignees.map(t=>B`
          <div
            ...
            title="${t.username}"
          >
            ${t.profilePicture?B`<img src="${t.profilePicture}" alt="${t.username}" />`:B`<span>${At(t.username)}</span>`}
          </div>
        `)}
      </div>
    `}_renderCustomFields(t){if(!this._config.show_custom_fields||!t.custom_fields||0===t.custom_fields.length)return B``;let e=t.custom_fields;return this._config.visible_custom_fields&&this._config.visible_custom_fields.length>0&&(e=e.filter(t=>this._config.visible_custom_fields.includes(t.id))),0===e.length?B``:B`
      <div class="custom-fields">
        ${e.map(t=>{const e=this._config.field_styles?.custom_fields?.[t.name]||"",i=this._config.field_icons?.custom_fields?.[t.name];return B`
            <div class="custom-field" style="${e}">
              ${i?B`<ha-icon icon="${i}"></ha-icon>`:""}
              <span class="field-name">${t.name}:</span>
              <span class="field-value">${function(t){if(null===t.value||void 0===t.value||""===t.value)return"-";switch(t.type){case"text":case"email":case"phone":case"url":default:return String(t.value);case"number":return Number(t.value).toLocaleString();case"currency":const e=t.type_config?.currency_type||"USD";return new Intl.NumberFormat(void 0,{style:"currency",currency:e}).format(Number(t.value));case"date":return Tt(t.value);case"checkbox":return t.value?"✓":"✗";case"drop_down":if(t.type_config?.options){const e=t.type_config.options.find(e=>e.id===t.value||e.name===t.value);return e?.name||String(t.value)}return String(t.value);case"labels":return Array.isArray(t.value)?t.value.join(", "):String(t.value);case"rating":const i=Number(t.value);return"★".repeat(i)+"☆".repeat(5-i);case"location":return"object"==typeof t.value&&t.value.location?t.value.location:String(t.value)}}(t)}</span>
            </div>
          `})}
      </div>
    ...
    `}_getMetadataGrid(){return this._config.metadata_grid?{columns:this._config.metadata_grid.columns||xt,gap:this._config.metadata_grid.gap||$t,fields:this._config.metadata_grid.fields}:this._buildDefaultMetadataGrid()}_buildDefaultMetadataGrid(){const t=[];return this._config.show_task_locations&&t.push({type:"location"}),(this._config.show_start_date||this._config.show_due_date)&&t.push({type:"dates"}),this._config.show_tags&&t.push({type:"tags",span:"full"}),this._config.show_assignees&&t.push({type:"assignees",span:"full"}),this._config.show_custom_fields&&t.push({type:"custom_fields",span:"full"}),{columns:xt,gap:$t,fields:t}}_renderMetadataField(t,e){const i=this._getFieldSpanStyle(t.span);switch(t.type){case"location":return this._renderLocationField(e,i);case"start_date":return this._renderStartDateField(e,i);case"due_date":return this._renderDueDateField(e,i);case"dates":return this._renderDatesField(e,i);case"tags":return this._renderTagsField(e,i);case"assignees":return this._renderAssigneesField(e,i);case"custom_fields":return this._renderCustomFieldsField(e,i);case"status":return this._renderStatusField(e,i);case"priority":return this._renderPriorityField(e,i);default:return B``}}_getFieldSpanStyle(t){return t?"full"===t?"grid-column: 1 / -1;":"number"==typeof t?`grid-column: span ${t};`:`grid-column: ${t};`:""}_renderLocationField(t,e){if(!this._config.show_task_locations)return B``;const i=[];if((t.space_info?.name||t.space?.name)&&i.push(t.space_info?.name||t.space.name),t.folder_info?.name&&i.push(t.folder_info.name),(t.list_info?.name||t.list?.name)&&i.push(t.list_info?.name||t.list.name),0===i.length)return B``;const a=this._config.field_icons?.location,s=a||"mdi:folder-outline",o=this._config.field_styles?.location||"";return B`
      <div class="task-location" style="${e} ${o}">
        <ha-icon icon="${s}"></ha-icon>
        <span>${i.join(" / ")}</span>
      </div>
    `}_renderStartDateField(t,e){if(!this._config.show_start_date||!t.start_date)return B``;const i=this._config.field_icons?.start_date,a=i||"mdi:calendar-start",s=this._config.field_styles?.start_date||"";return B`
      <span class="date-item start-date" style="${e} ${s}">
        <ha-icon icon="${a}"></ha-icon>
        ${Tt(t.start_date)}
      </span>
    `}_renderDueDateField(t,e){if(!this._config.show_due_date||!t.due)return B``;const i=this._config.field_icons?.due_date,a=i||"mdi:calendar-end",s=this._config.field_styles?.due_date||"";return B`
      <span class="date-item due-date ${Et(t.due)}" style="${e} ${s}">
        <ha-icon icon="${a}"></ha-icon>
        ${Tt(t.due)}
      </span>
    `}_renderDatesField(t,e){const i=this._config.show_start_date,a=this._config.show_due_date;if(!i&&!a)return B``;const s=this._config.field_styles?.dates||"";return B`
      <div class="task-dates" style="${e} ${s}">
        ${i?this._renderStartDateField(t,""):""}
        ${a?this._renderDueDateField(t,""):""}
      </div>
    `}_renderTagsField(t,e){if(!this._config.show_tags||!t.tags||0===t.tags.length)return B``;const i=this._config.field_styles?.tags||"";return B`
      <div class="task-tags" style="${e} ${i}">
        ${t.tags.map(t=>B`
          <span
            class="tag"
            style="
    ...
    `}_renderAssigneesField(t,e){if(!this._config.show_assignees||!t.assignees||0===t.assignees.length)return B``;const i=this._config.field_styles?.assignees||"";return B`
      <div class="task-assignees" style="${e} ${i}">
        ${t.assignees.map(t=>B`
          <div
            class="assignee-avatar"
            style="${t.color?`background-color: ${t.color}`:""}"
    ...
    `}_renderCustomFieldsField(t,e){if(!this._config.show_custom_fields)return B``;const i=this._renderCustomFields(t);return i&&0!==i.values.length?B`<div style="${e}">${i}</div>`:B``}_renderStatusField(t,e){if(!this._config.show_status||!t.clickup_status)return B``;const i=this._config.field_styles?.status||"";return B`
      <span
        class="status-badge"
        style="--status-color: ${t.clickup_status.color||"#d3d3d3"}; ${e} ${i}"
      >
        ${t.clickup_status.status}
      </span>
    `}_renderPriorityField(t,e){if(!this._config.show_priority||null===t.priority||void 0===t.priority)return B``;const i=t.priority,a=this._config.field_icons?.priority,s=a||vt[i]||vt.null,o=bt[i]||bt.null,r=this._config.field_styles?.priority||"";return B`
      <ha-icon
        class="priority-icon"
        icon="${s}"
        style="color: ${o}; ${e} ${r}"
      ></ha-icon>
    `}_renderTaskLocation(t){if(!this._config.show_task_locations)return B``;const e=[];if((t.space_info?.name||t.space?.name)&&e.push(t.space_info?.name||t.space.name),t.folder_info?.name&&e.push(t.folder_info.name),(t.list_info?.name||t.list?.name)&&e.push(t.list_info?.name||t.list.name),0===e.length)return B``;const i=this._config.field_icons?.location,a=i||"mdi:folder-outline",s=this._config.field_styles?.location||"";return B`
    ...
    `}async _submitAddTask(){const t=this.shadowRoot?.querySelector("#add-summary")?.value?.trim();if(!t)return;const e=this.shadowRoot?.querySelector("#add-description")?.value?.trim(),i=this.shadowRoot?.querySelector("#add-status")?.value,a=this.shadowRoot?.querySelector("#add-start-date")?.value,s=this.shadowRoot?.querySelector("#add-due-date")?.value,o=this.shadowRoot?.querySelector("#add-priority")?.value;try{const r={item:t};e&&(r.description=e),s&&(r.due=s),await this.hass.callService("todo","add_item",r,{entity_id:this._config.entity}),(i||o||a)&&setTimeout(async()=>{try{const e=this.hass.states[this._config.entity],s=(e?.attributes?.clickup_tasks||[]).find(e=>e.summary===t);s&&s.clickup_id&&(i&&await this.hass.callService("clickup","update_task_status",{task_id:s.clickup_id,status:i}),o&&await this.hass.callService("clickup","update_task_priority",{task_id:s.clickup_id,priority:parseInt(o)}),a&&await this.hass.callService("clickup","update_task_start_date",{task_id:s.clickup_id,start_date:new Date(a).getTime()}))}catch(t){console.error("Error updating task details:",t)}},1e3),this._showAddDialog=!1}catch(t){console.error("Error adding task:",t)}}async _submitEditTask(){if(!this._editingTask)return;const t=this.shadowRoot?.querySelector("#edit-summary")?.value?.trim();if(!t)return;const e=this.shadowRoot?.querySelector("#edit-description")?.value?.trim(),i=this.shadowRoot?.querySelector("#edit-status")?.value,a=this.shadowRoot?.querySelector("#edit-start-date")?.value,s=this.shadowRoot?.querySelector("#edit-due-date")?.value,o=this.shadowRoot?.querySelector("#edit-priority")?.value;try{const r=this._editingTask.clickup_id,n={entity_id:this._config.entity,item:this._editingTask.uid,rename:t};if(void 0!==e&&(n.description=e||null),s&&(n.due=s),await this.hass.callService("todo","update_item",n),r){i&&i!==this._editingTask.clickup_status?.status&&await this.hass.callService("clickup","update_task_status",{task_id:r,status:i});const t=o?parseInt(o):null;t!==this._editingTask.priority&&await this.hass.callService("clickup","update_task_priority",{task_id:r,priority:t});a!==(this._editingTask.start_date?new Date("number"==typeof this._editingTask.start_date?this._editingTask.start_date:parseInt(this._editingTask.start_date)).toISOString().split("T")[0]:"")&&await this.hass.callService("clickup","update_task_start_date",{task_id:r,start_date:a?new Date(a).getTime():null})}this._editingTask=null}catch(t){console.error("Error updating task:",t)}}async _deleteTask(t){if(confirm(`Delete task "${t.summary}"?`))try{await this.hass.callService("todo","remove_item",{entity_id:this._config.entity,item:t.uid}),this._editingTask=null}catch(t){console.error("Error deleting task:",t)}}async _handleTaskNameChange(t,e){if(e===t.summary)return;const i=await async function(t,e,i,a){try{return a&&""!==a.trim()?(await t.callService("todo","update_item",{entity_id:e,item:i.uid,rename:a.trim()}),{success:!0}):{success:!1,error:"Task name cannot be empty"}}catch(t){return console.error("Error updating task name:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}(this.hass,this._config.entity,t,e);i.success||console.error("Failed to update task name:",i.error)}async _handlePriorityChange(t,e){if(e===t.priority)return;const i=await async function(t,e,i){try{return e.clickup_id?null!==i&&(i<1||i>4)?{success:!1,error:"Priority must be between 1 and 4, or null"}:(await t.callService("clickup","update_task_priority",{task_id:e.clickup_id,priority:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task priority:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}(this.hass,t,e);i.success||console.error("Failed to update priority:",i.error)}_getAvailableStatuses(){if(!this.hass||!this._config.entity)return[];const t=this.hass.states[this._config.entity];return t?function(t,e){const i=new Map,a=t.attributes?.available_statuses||[];return a.length>0&&a.forEach(t=>{i.set(t.status,{name:t.status,color:t.color||"#d3d3d3",type:t.type||"custom"})}),e.forEach(t=>{(t.list_info?.statuses||[]).forEach(t=>{i.has(t.status)||i.set(t.status,{name:t.status,color:t.color||"#d3d3d3",type:t.type||"custom"})})}),e.forEach(t=>{t.clickup_status?.status&&!i.has(t.clickup_status.status)&&i.set(t.clickup_status.status,{name:t.clickup_status.status,color:t.clickup_status.color||"#d3d3d3",type:t.clickup_status.type||"custom"})}),0===i.size?[{name:"TO DO",color:"#d3d3d3",type:"open"},{name:"IN PROGRESS",color:"#4194f6",type:"custom"},{name:"IN REVIEW",color:"#f6c342",type:"custom"},{name:"COMPLETE",color:"#6bc950",type:"closed"},{name:"BLOCKED",color:"#f50000",type:"custom"}]:Array.from(i.values()).sort((t,e)=>t.name.localeCompare(e.name))}(t,this._tasks):[]}async _handleStatusChange(t,e){if(e?.name===t.clickup_status?.status)return;const i=await Ft(this.hass,t,e.name);i.success||console.error("Failed to update status:",i.error)}async _handleDueDateChange(t,e){const i=await async function(t,e,i,a){try{let s=null;return a&&(s=a instanceof Date?a.toISOString().split("T")[0]:a),await t.callService("todo","update_item",{entity_id:e,item:i.uid,due:s}),{success:!0}}catch(t){return console.error("Error updating task due date:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}(this.hass,this._config.entity,t,e);i.success||console.error("Failed to update due date:",i.error)}async _handleStartDateChange(t,e){const i=await async function(t,e,i){try{if(!e.clickup_id)return{success:!1,error:"Task does not have a ClickUp ID"};let a=null;return i&&(a=i instanceof Date?i.getTime():"string"==typeof i?new Date(i).getTime():i),await t.callService("clickup","update_task_start_date",{task_id:e.clickup_id,start_date:a}),{success:!0}}catch(t){return console.error("Error updating task start date:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}(this.hass,t,e);i.success||console.error("Failed to update start date:",i.error)}async _handleAssigneesChange(t,e){const i=e.map(t=>t.id),a=await async function(t,e,i){try{return e.clickup_id?(await t.callService("clickup","update_task_assignees",{task_id:e.clickup_id,assignees:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task assignees:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}(this.hass,t,i);a.success||console.error("Failed to update assignees:",a.error)}async _handleTagsChange(t,e){const i=e.map(t=>t.name),a=await async function(t,e,i){try{return e.clickup_id?(await t.callService("clickup","update_task_tags",{task_id:e.clickup_id,tags:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task tags:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}(this.hass,t,i);a.success||console.error("Failed to update tags:",a.error)}_getAvailableAssignees(){const t=new Map;return this._tasks.forEach(e=>{e.assignees&&e.assignees.forEach(e=>{t.has(e.id)||t.set(e.id,e)})}),Array.from(t.values())}_toggleSelection(t){this._selectedTasks.has(t)?this._selectedTasks.delete(t):this._selectedTasks.add(t),this.requestUpdate(),this._selectionMode=this._selectedTasks.size>0}_selectAll(){this._tasks.forEach(t=>{this._selectedTasks.add(t.uid)}),this._selectionMode=!0,this.requestUpdate()}_clearSelection(){this._selectedTasks.clear(),this._selectionMode=!1,this.requestUpdate()}async _bulkUpdateStatus(t){const e=this._tasks.filter(t=>this._selectedTasks.has(t.uid));for(const i of e){const e=await Ft(this.hass,i,t);e.success||console.error("Failed to update status:",e.error)}this._clearSelection()}async _bulkDelete(){if(!confirm(`Delete ${this._selectedTasks.size} tasks?`))return;const t=this._tasks.filter(t=>this._selectedTasks.has(t.uid));for(const e of t)try{await this.hass.callService("todo","remove_item",{entity_id:this._config.entity,item:e.uid})}catch(t){console.error("Error deleting task:",t)}this._clearSelection()}_handleDragStart(t){this._draggedTask=t}_handleDragEnd(){this._draggedTask=null,this._dragOverTask=null}_handleDragOver(t,e){t.preventDefault(),this._draggedTask&&this._draggedTask.uid!==e.uid&&(this._dragOverTask=e.uid)}_handleDragLeave(){this._dragOverTask=null}_handleDrop(t,e){if(t.preventDefault(),!this._draggedTask||this._draggedTask.uid===e.uid)return void(this._dragOverTask=null);const i=[...this._displayedTasks],a=i.findIndex(t=>t.uid===this._draggedTask.uid),s=i.findIndex(t=>t.uid===e.uid);if(-1===a||-1===s)return void(this._dragOverTask=null);i.splice(a,1),i.splice(s,0,this._draggedTask);const o=new Set(i.map(t=>t.uid)),r=this._tasks.filter(t=>!o.has(t.uid)),n=[...i,...r],l=n.map(t=>t.uid);!function(t,e){try{const i=Dt(t);localStorage.setItem(i,JSON.stringify(e))}catch(t){console.error("Error saving custom order:",t)}}(this._config.entity,l),"custom"!==this._config.sort_by&&(this._config={...this._config,sort_by:"custom"},_t(this,"config-changed",{config:this._config})),this._tasks=n,this._displayedTasks=i,this._dragOverTask=null,console.log("Task reordered and saved:",{task:this._draggedTask.summary,from:a,to:s,totalTasks:n.length,displayedTasks:i.length})}static get styles(){return zt}}t([pt({attribute:!1})],Vt.prototype,"hass",void 0),t([ut()],Vt.prototype,"_config",void 0),t([ut()],Vt.prototype,"_tasks",void 0),t([ut()],Vt.prototype,"_displayedTasks",void 0),t([ut()],Vt.prototype,"_editingTask",void 0),t([ut()],Vt.prototype,"_showAddDialog",void 0),t([ut()],Vt.prototype,"_selectedTasks",void 0),t([ut()],Vt.prototype,"_selectionMode",void 0),t([ut()],Vt.prototype,"_draggedTask",void 0),t([ut()],Vt.prototype,"_dragOverTask",void 0),customElements.get("clickup-todo-card")||(customElements.define("clickup-todo-card",Vt),console.log("ClickUp Todo Card: Manually registered custom element")),window.customCards=window.customCards||[],window.customCards.push({type:"clickup-todo-card",name:"ClickUp Todo Card",description:"Enhanced todo card with ClickUp custom fields and filters",preview:!0,documentationURL:"https://github.com/chbarnhouse/clickup-todo-card"}),console.log("ClickUp Todo Card: Registered in customCards array");class Rt extends nt{constructor(){super(),this._config={type:"custom:clickup-todo-card",entity:""},this._tasks=[],this._selectedTab=0,console.log("ClickUp Card Editor: Constructor called")}connectedCallback(){super.connectedCallback()}setConfig(t){this._config={type:"custom:clickup-todo-card",entity:"",...t},this._loadEntityData()}_loadEntityData(){if(!this.hass||!this._config.entity)return;const t=this.hass.states[this._config.entity];t&&(this._tasks=kt(t))}render(){try{if(!this.hass)return B`<div>Loading hass...</div>`;if(!this._config)return B`<div>Loading config...</div>`;const t=this._tasks.length>0?function(t){const e=new Map;return t.forEach(t=>{t.clickup_status?.status&&e.set(t.clickup_status.status,t.clickup_status.status)}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks):[],e=this._tasks.length>0?function(t){const e=new Set;return t.forEach(t=>{t.tags?.forEach(t=>{t.name&&e.add(t.name)})}),Array.from(e).map(t=>({value:t,label:t})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks):[],i=this._tasks.length>0?function(t){const e=new Map;return t.forEach(t=>{t.assignees?.forEach(t=>{t.id&&t.username&&e.set(t.id.toString(),t.username)})}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks):[],a=this._tasks.length>0?function(t){const e=new Map;return t.forEach(t=>{t.custom_fields?.forEach(t=>{t.id&&t.name&&e.set(t.id,t.name)})}),Array.from(e.entries()).map(([t,e])=>({value:t,label:e})).sort((t,e)=>t.label.localeCompare(e.label))}(this._tasks):[];return B`
      <div class="card-config">
        <div class="tabs">
          ...
          <button
            class="tab ${5===this._selectedTab?"active":""}"
        ...
        <div class="tab-content">
          ...
          ${5===this._selectedTab?this._renderStylingTab(a):""}
        </div>
      </div>
      ...
      <div class="tab-panel">
        ...
        <div class="config-section">
          ...
          `:B`
            ...
            ${this._config.show_custom_fields&&t.length>0?B`
      ...
      <div class="tab-panel">
        ...
        <div class="config-section">
          ...
          <ha-textfield
            label="Status Style"
            .value=${e.status||""}
            @input=${t=>this._updateFieldStyle("status",t.target.value)}
          ...
          <ha-textfield
            ...
            .value=${e.priority||""}
            @input=${t=>this._updateFieldStyle("priority",t.target.value)}
          ...
          <ha-textfield
            ...
            .value=${e.due_date||""}
            @input=${t=>this._updateFieldStyle("due_date",t.target.value)}
          ...
          <ha-textfield
            ...
            .value=${e.start_date||""}
            @input=${t=>this._updateFieldStyle("start_date",t.target.value)}
          ...
          <ha-textfield
            label="Tags Style"
            .value=${e.tags||""}
            @input=${t=>this._updateFieldStyle("tags",t.target.value)}
          ...
          <ha-textfield
            ...
            .value=${e.assignees||""}
            @input=${t=>this._updateFieldStyle("assignees",t.target.value)}
    ...
    `}}t([pt({attribute:!1})],Rt.prototype,"hass",void 0),t([ut()],Rt.prototype,"_config",void 0),t([ut()],Rt.prototype,"_tasks",void 0),t([ut()],Rt.prototype,"_helpers",void 0),t([ut()],Rt.prototype,"_selectedTab",void 0),customElements.get("clickup-todo-card-editor")||(customElements.define("clickup-todo-card-editor",Rt),console.log("ClickUp Todo Card Editor: Manually registered custom element"));var jt=Object.freeze({__proto__:null,ClickUpTodoCardEditor:Rt});export{Vt as ClickUpTodoCard};
