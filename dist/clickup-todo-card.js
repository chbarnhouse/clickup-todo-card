...
`;async function Et(t,e,i){try{return e.clickup_id?(await t.callService("clickup","update_task_status",{task_id:e.clickup_id,status:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task status:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}let St=class extends nt{constructor(){super(...arguments),this.value="",this.editing=!1,this.placeholder="Click to edit",this.required=!1,this.multiline=!1,this._tempValue="",this._error=""}static{this.styles=r`
  ...
  `}render(){return j`
    ...
    `}_renderDialog(){const t={open:[],closed:[],custom:[]};return this.options.forEach(e=>{const i=e.type||"custom";i in t&&t[i].push(e)}),j`
      <ha-dialog
        .open=${this._isOpen}
        ...
        <div class="status-options">
          ${t.open.length>0?j`
            <div class="status-group">
              ...
              ${t.open.map(t=>this._renderOption(t))}
            </div>
          `:""}
          ${t.custom.length>0?j`
            <div class="status-group">
              <div class="group-label">Custom</div>
              ${t.custom.map(t=>this._renderOption(t))}
            </div>
          `:""}
          ${t.closed.length>0?j`
            <div class="status-group">
