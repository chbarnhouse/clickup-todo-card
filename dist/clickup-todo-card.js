...
`;let Ct=class extends nt{constructor(){super(...arguments),this.value="",this.editing=!1,this.placeholder="Click to edit",this.required=!1,this.multiline=!1,this._tempValue="",this._error=""}static{this.styles=r`
  ...
  `}render(){return j`
    ...
    `}_renderDisplay(){const t=St.find(t=>t.value===this.value)||St[4];return j`
      <div
    ...
    `}_toggleDropdown(){this._isOpen=!this._isOpen,this._isOpen&&setTimeout(()=>{const t=e=>{this.shadowRoot?.contains(e.target)||(this._isOpen=!1,document.removeEventListener("click",t))};document.addEventListener("click",t)},0)}_selectPriority(t){const e=this.value;e!==t&&(this.value=t,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,oldValue:e},bubbles:!0,composed:!0}))),this._isOpen=!1}connectedCallback(){super.connectedCallback(),this._handleKeyDown=this._handleKeyDown.bind(this),document.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._handleKeyDown)}_handleKeyDown(t){"Escape"===t.key&&this._isOpen&&(this._isOpen=!1)}};t([ht({type:Number})],Dt.prototype,"value",void 0),t([ht({type:Boolean})],Dt.prototype,"showLabel",void 0),t([ht({type:Boolean})],Dt.prototype,"compact",void 0),t([ut()],Dt.prototype,"_isOpen",void 0),Dt=t([ct("editable-priority")],Dt);let zt=class extends nt{constructor(){super(...arguments),this.value=null,this.label="Date",this.icon="mdi:calendar",this.compact=!1,this.allowNull=!0,this.dateType="due",this._editing=!1,this._tempValue=""}static{this.styles=r`
    :host {
      display: inline-block;
      position: relative;
    }
  ...
  `}render(){return j`
    ...
    `}_startAdding(){this._isAdding=!0,this._newTagName="",requestAnimationFrame(()=>{this._input?.focus()})}_handleInput(t){const e=t.target;this._newTagName=e.value}_handleKeyDown(t){"Enter"===t.key?(t.preventDefault(),this._addTag()):"Escape"===t.key&&(t.preventDefault(),this._cancelAdding())}_handleBlur(){setTimeout(()=>{this._isAdding&&this._newTagName.trim()?this._addTag():this._isAdding&&this._cancelAdding()},200)}_addTag(){const t=this._newTagName.trim();if(!t)return void this._cancelAdding();if(this.value.some(e=>e.name.toLowerCase()===t.toLowerCase()))return void this._cancelAdding();const e=this.value,i={name:t},a=[...this.value,i];this.value=a,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:a,oldValue:e},bubbles:!0,composed:!0})),this._newTagName="",this._isAdding=!1}_removeTag(t){const e=this.value,i=this.value.filter((e,i)=>i!==t);this.value=i,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:i,oldValue:e},bubbles:!0,composed:!0}))}_cancelAdding(){this._isAdding=!1,this._newTagName=""}};t([ht({type:Array})],Pt.prototype,"value",void 0),t([ht({type:Boolean})],Pt.prototype,"compact",void 0),t([ut()],Pt.prototype,"_isAdding",void 0),t([ut()],Pt.prototype,"_newTagName",void 0),t([gt("input")],Pt.prototype,"_input",void 0),Pt=t([ct("editable-tags")],Pt),console.info("%c  CLICKUP-TODO-CARD  \n%c  Version 2.0.0  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");class Ut extends nt{constructor(){super(...arguments),this._config={type:"custom:clickup-todo-card",entity:"",...yt},this._tasks=[],this._editingTask=null,this._showAddDialog=!1,this._statusDropdownTask=null,this._selectedTasks=new Set,this._selectionMode=!1,this._draggedTask=null,this._dragOverTask=null}get config(){return this._config}static async getConfigElement(){return await Promise.resolve().then(function(){return It}),document.createElement("clickup-todo-card-editor")}static getStubConfig(){return{type:"custom:clickup-todo-card",entity:"",...yt}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={...yt,...t}}getCardSize(){return 3+(this._tasks?.length||0)}shouldUpdate(t){if(!this._config||!this.hass)return!0;if(!this._config.entity)return!0;try{return function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var a=e.get("hass");return!a||a.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}catch(t){return console.error("Error in shouldUpdate:",t),!0}}render(){try{if(!this._config||!this.hass)return j`<ha-card><div class="warning">Loading...</div></ha-card>`;if(!this._config.entity)return j`
        ...
        `;this._tasks=xt(t);const e=$t(function(t,e){let i=[...t];if(!e.filters)return i;if(e.filters.status?.length&&(i=i.filter(t=>{const i=t.clickup_status?.status;return i&&e.filters.status.includes(i)})),e.filters.priority?.length&&(i=i.filter(t=>{const i=null===t.priority?null:t.priority;return e.filters.priority.includes(i)})),e.filters.tags?.length&&(i=i.filter(t=>!!t.tags?.length&&t.tags.some(t=>e.filters.tags.includes(t.name)))),e.filters.assignees?.length&&(i=i.filter(t=>!!t.assignees?.length&&t.assignees.some(t=>e.filters.assignees.includes(t.id.toString())))),e.filters.due_date_range){const{start:t,end:a}=e.filters.due_date_range;i=i.filter(e=>{if(!e.due)return!1;const i=new Date(e.due).getTime();return!(t&&i<new Date(t).getTime())&&!(a&&i>new Date(a).getTime())})}return i}(this._tasks,this._config),this._config),i=Tt(e,this._config.group_by||"none",this._config.group_field_id),a=!1!==this._config.add_button_overlay,o=this._config.add_button_position||"bottom-right",s=!a&&o.startsWith("top"),r=!a&&o.startsWith("bottom");return j`
        <ha-card>
          ${this._renderHeader(t)}
          ${this._selectionMode?this._renderBulkActionsToolbar():""}
          ${s?j`<div class="button-container">${this._renderFloatingAddButton(t)}</div>`:""}
          ...
          ${a?this._renderFloatingAddButton(t):""}
        </ha-card>
    ...
    `}_renderBulkActionsToolbar(){const t=this._selectedTasks.size,e=kt(this.hass.states[this._config.entity]);return j`
    ...
    `}}t([ht({attribute:!1})],Nt.prototype,"hass",void 0),t([ut()],Nt.prototype,"_config",void 0),t([ut()],Nt.prototype,"_tasks",void 0),t([ut()],Nt.prototype,"_helpers",void 0),customElements.get("clickup-todo-card-editor")||(customElements.define("clickup-todo-card-editor",Nt),console.log("ClickUp Todo Card Editor: Manually registered custom element"));var It=Object.freeze({__proto__:null,ClickUpTodoCardEditor:Nt});export{Ut as ClickUpTodoCard};
