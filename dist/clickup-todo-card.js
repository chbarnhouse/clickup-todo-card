...
`;async function zt(t,e,i){try{return e.clickup_id?(await t.callService("clickup","update_task_status",{task_id:e.clickup_id,status:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task status:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}let Ot=class extends nt{constructor(){super(...arguments),this.value="",this.editing=!1,this.placeholder="Click to edit",this.required=!1,this.multiline=!1,this._tempValue="",this._error=""}static{this.styles=r`
  ...
  `}render(){return j`
    ...
    `}_toggleDropdown(){this._isOpen=!this._isOpen,this._isOpen&&setTimeout(()=>{const t=e=>{this.shadowRoot?.contains(e.target)||(this._isOpen=!1,document.removeEventListener("click",t))};document.addEventListener("click",t)},0)}_selectPriority(t){const e=this.value;e!==t&&(this.value=t,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,oldValue:e},bubbles:!0,composed:!0}))),this._isOpen=!1}connectedCallback(){super.connectedCallback(),this._handleKeyDown=this._handleKeyDown.bind(this),document.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._handleKeyDown)}_handleKeyDown(t){"Escape"===t.key&&this._isOpen&&(this._isOpen=!1)}};t([ht({type:Number})],Ft.prototype,"value",void 0),t([ht({type:Boolean})],Ft.prototype,"showLabel",void 0),t([ht({type:Boolean})],Ft.prototype,"compact",void 0),t([ut()],Ft.prototype,"_isOpen",void 0),Ft=t([ct("editable-priority")],Ft);let Nt=class extends nt{constructor(){super(...arguments),this.value=null,this.label="Date",this.icon="mdi:calendar",this.compact=!1,this.allowNull=!0,this.dateType="due",this._editing=!1,this._tempValue=""}static{this.styles=r`
    :host {
      display: inline-block;
      position: relative;
    }
  ...
  `}render(){return j`
    ...
    `}}t([ht({attribute:!1})],Lt.prototype,"hass",void 0),t([ut()],Lt.prototype,"_config",void 0),t([ut()],Lt.prototype,"_tasks",void 0),t([ut()],Lt.prototype,"_helpers",void 0),customElements.get("clickup-todo-card-editor")||(customElements.define("clickup-todo-card-editor",Lt),console.log("ClickUp Todo Card Editor: Manually registered custom element"));var Rt=Object.freeze({__proto__:null,ClickUpTodoCardEditor:Lt});export{Vt as ClickUpTodoCard};
