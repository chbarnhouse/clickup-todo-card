        ...
        <div class="config-section">
          ...
          ${t.length>0?I`
            <div class="entity-hint">
              ...
              <ul>
                ${t.slice(0,10).map(t=>I`
                  <li>
                    <a href="#" @click=${e=>{e.preventDefault(),this._entityChanged(t)}}>
                      ${t}
                    </a>
                  </li>
                `)}
                ${t.length>10?I`
                  <li>...and ${t.length-10} more</li>
                `:""}
              </ul>
            </div>
          `:""}
