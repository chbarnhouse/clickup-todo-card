...
`;async function Ft(t,e,i){try{return e.clickup_id?(await t.callService("clickup","update_task_status",{task_id:e.clickup_id,status:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task status:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}let Ot=class extends nt{constructor(){super(...arguments),this.value="",this.editing=!1,this.placeholder="Click to edit",this.required=!1,this.multiline=!1,this._tempValue="",this._error=""}static{this.styles=r`
  ...
  `}render(){return B`
      ...
      <div class="task-dates" style="${c}">
        ${e?B`
          <span class="date-item start-date" style="${o}">
            ...
            ${t.start_date?Tt(t.start_date):"—"}
          </span>
        `:""}

        ${i?B`
          <span class="date-item due-date ${t.due?Et(t.due):""}" style="${l}">
    ...
    `}_renderTaskMetadata(t){const e=this._getMetadataGrid();if(!e.fields||0===e.fields.length)return B``;const i=e.columns||xt,a=e.gap||kt,s=this._config.compact_mode?"4px 6px":a;return B`
      <div
        class="task-metadata"
        style="
    ...
    `}_renderTagsField(t,e){if(!this._config.show_tags)return B``;const i=t.tags&&t.tags.length>0;if(!i&&!this._config.always_show_fields?.tags)return B``;const a=this._config.field_styles?.tags||"";return B`
      <div class="task-tags" style="${e} ${a}">
        ${i?t.tags.map(t=>B`
          <span
            class="tag"
            style="
    ...
    `}_renderAssigneesField(t,e){if(!this._config.show_assignees)return B``;const i=t.assignees&&t.assignees.length>0;if(!i&&!this._config.always_show_fields?.assignees)return B``;const a=this._config.field_styles?.assignees||"";return B`
      <div class="task-assignees" style="${e} ${a}">
        ${i?t.assignees.map(t=>B`
          <div
            class="assignee-avatar"
            style="${t.color?`background-color: ${t.color}`:""}"
            title="${t.username}"
    ...
    `}_renderCustomFieldsField(t,e){if(!this._config.show_custom_fields)return B``;const i=this._renderCustomFields(t);return i&&0!==i.values.length?B`<div style="${e}">${i}</div>`:B``}_renderStatusField(t,e){if(!this._config.show_status)return B``;if(!t.clickup_status&&!this._config.always_show_fields?.status)return B``;const i=this._config.field_styles?.status||"",a=t.clickup_status?.color||"#d3d3d3",s=t.clickup_status?.status||"—";return B`
      <span
        class="status-badge"
        style="--status-color: ${a}; ${e} ${i}"
      >
        ${s}
      </span>
    `}_renderPriorityField(t,e){if(!this._config.show_priority)return B``;if(!(null!==t.priority&&void 0!==t.priority)&&!this._config.always_show_fields?.priority)return B``;const i=t.priority??null,a=this._config.field_icons?.priority,s=a||vt[i]||vt.null,o=bt[i]||bt.null,r=this._config.field_styles?.priority||"";return B`
      <ha-icon
        class="priority-icon"
        icon="${s}"
        style="color: ${o}; ${e} ${r}"
      ...
      <div class="tab-panel">
        ...
        <div class="config-section">
          ...
          <div class="config-section">
            ...
            ${this._config.show_custom_fields?0===t.length?B`
          ...
          <div class="config-section">
            ...
            `:B`
              ...
              ${this._renderCustomFieldCustomization(t)}
            `:B`
              <div class="info-box" style="background: var(--secondary-background-color); padding: 16px; border-radius: 8px; margin-top: 8px;">
                <p style="margin: 0; color: var(--secondary-text-color);">
                  <ha-icon icon="mdi:information" style="vertical-align: middle;"></ha-icon>
    ...
    `}_renderFieldCustomization(){const t=this._config.field_styles||{},e=this._config.field_icons||{};return B`
      <div class="field-customization-list">
        ${[{key:"priority",label:"Priority",defaultIcon:"mdi:flag"},{key:"status",label:"Status",defaultIcon:"mdi:circle"},{key:"start_date",label:"Start Date",defaultIcon:"mdi:calendar-start"},{key:"due_date",label:"Due Date",defaultIcon:"mdi:calendar-end"},{key:"tags",label:"Tags",defaultIcon:"mdi:tag-multiple"},{key:"assignees",label:"Assignees",defaultIcon:"mdi:account-multiple"},{key:"location",label:"Location",defaultIcon:"mdi:folder-outline"}].map(i=>{const a=e[i.key]||i.defaultIcon,s=t[i.key]||"";return B`
            <details class="field-custom-details">
              <summary class="field-custom-summary">
                ${i.label}
                ${a!==i.defaultIcon||s?B`<span class="customized-indicator">●</span>`:""}
              </summary>
              <div class="field-custom-content">
                <ha-icon-picker
                  ...
                  @value-changed=${t=>this._updateFieldIcon(i.key,t.detail.value)}
                ></ha-icon-picker>

                <ha-textfield
                  label="Custom CSS"
                  .value=${s}
                  @input=${t=>this._updateFieldStyle(i.key,t.target.value)}
    ...
    `}}t([pt({attribute:!1})],jt.prototype,"hass",void 0),t([ut()],jt.prototype,"_config",void 0),t([ut()],jt.prototype,"_tasks",void 0),t([ut()],jt.prototype,"_helpers",void 0),t([ut()],jt.prototype,"_selectedTab",void 0),customElements.get("clickup-todo-card-editor")||(customElements.define("clickup-todo-card-editor",jt),console.log("ClickUp Todo Card Editor: Manually registered custom element"));var Rt=Object.freeze({__proto__:null,ClickUpTodoCardEditor:jt});export{Vt as ClickUpTodoCard};
