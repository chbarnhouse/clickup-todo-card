  ...
  `}render(){return B`
    ...
    `}_renderDates(t){const e=this._config.show_start_date&&(t.start_date||this._config.always_show_fields?.start_date),i=this._config.show_due_date&&(t.due||this._config.always_show_fields?.due_date);if(!e&&!i)return B``;const a=this._config.field_icons?.start_date,s=a||"mdi:calendar-start",o=this._config.field_styles?.start_date||"",r=this._config.field_icons?.due_date,n=r||"mdi:calendar-end",l=this._config.field_styles?.due_date||"",c=this._config.field_styles?.dates||"";return B`
      <div class="task-dates" style="${c}">
        ...
        ${i?B`
          <span class="date-item due-date ${t.due?Dt(t.due):""}" style="${l}">
    ...
    `}_renderDueDateField(t,e){if(!this._config.show_due_date)return B``;if(!t.due&&!this._config.always_show_fields?.due_date)return B``;const i=this._config.field_icons?.due_date,a=i||"mdi:calendar-end",s=this._config.field_styles?.due_date||"";return B`
      <span class="date-item due-date ${t.due?Dt(t.due):""}" style="${e} ${s}">
        <ha-icon icon="${a}"></ha-icon>
        ${t.due?Tt(t.due):"—"}
      </span>
    ...
    `}_renderFieldCustomization(){const t=this._config.field_styles||{},e=this._config.field_icons||{};return B`
      <div class="field-customization-list">
        ${[{key:"priority",label:"Priority"},{key:"status",label:"Status"},{key:"start_date",label:"Start Date"},{key:"due_date",label:"Due Date"},{key:"tags",label:"Tags"},{key:"assignees",label:"Assignees"},{key:"location",label:"Location"}].map(i=>B`
          <details class="field-custom-details">
            <summary class="field-custom-summary">${i.label}</summary>
