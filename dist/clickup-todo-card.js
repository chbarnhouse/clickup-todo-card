...
`;async function Ct(t,e,i){try{return e.clickup_id?(await t.callService("clickup","update_task_status",{task_id:e.clickup_id,status:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task status:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}let Et=class extends nt{constructor(){super(...arguments),this.value="",this.editing=!1,this.placeholder="Click to edit",this.required=!1,this.multiline=!1,this._tempValue="",this._error=""}static{this.styles=r`
    :host {
      display: block;
      position: relative;
    }
  ...
  `}render(){return j`
    ...
    `}_openDialog(){this._isOpen=!0}_closeDialog(){this._isOpen=!1}_selectStatus(t){const e=this.value;(e?.name||e?.status||"")!==(t.name||t.status||"")&&(this.value=t,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t,oldValue:e},bubbles:!0,composed:!0}))),this._isOpen=!1}};t([ht({type:Object})],Ut.prototype,"value",void 0),t([ht({type:Array})],Ut.prototype,"options",void 0),t([ht({type:Boolean})],Ut.prototype,"compact",void 0),t([ut()],Ut.prototype,"_isOpen",void 0),Ut=t([ct("editable-status")],Ut),console.info("%c  CLICKUP-TODO-CARD  \n%c  Version 2.0.20  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");class It extends nt{constructor(){super(...arguments),this._config={type:"custom:clickup-todo-card",entity:"",...yt},this._tasks=[],this._displayedTasks=[],this._editingTask=null,this._showAddDialog=!1,this._selectedTasks=new Set,this._selectionMode=!1,this._draggedTask=null,this._dragOverTask=null}get config(){return this._config}static async getConfigElement(){return await Promise.resolve().then(function(){return Vt}),document.createElement("clickup-todo-card-editor")}static getStubConfig(){return{type:"custom:clickup-todo-card",entity:"",...yt}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={...yt,...t}}getCardSize(){return 3+(this._tasks?.length||0)}shouldUpdate(t){if(!this._config||!this.hass)return!0;if(!this._config.entity)return!0;try{return function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var a=e.get("hass");return!a||a.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}catch(t){return console.error("Error in shouldUpdate:",t),!0}}render(){try{if(!this._config||!this.hass)return j`<ha-card><div class="warning">Loading...</div></ha-card>`;if(!this._config.entity)return j`
        ...
        `;this._tasks=xt(t);let e=this._tasks;if("custom"===this._config.sort_by){const t=function(t){try{const e=St(t),i=localStorage.getItem(e);return i?JSON.parse(i):null}catch(t){return console.error("Error loading custom order:",t),null}}(this._config.entity);t&&(e=function(t,e){const i=new Map(t.map(t=>[t.uid,t])),a=[],o=new Set;for(const t of e){const e=i.get(t);e&&(a.push(e),o.add(t))}for(const e of t)o.has(e.uid)||a.push(e);return a}(this._tasks,t))}const i=kt(function(t,e){let i=[...t];if(!e.filters)return i;if(e.filters.status?.length&&(i=i.filter(t=>{const i=t.clickup_status?.status;return i&&e.filters.status.includes(i)})),e.filters.priority?.length&&(i=i.filter(t=>{const i=null===t.priority?null:t.priority;return e.filters.priority.includes(i)})),e.filters.tags?.length&&(i=i.filter(t=>!!t.tags?.length&&t.tags.some(t=>e.filters.tags.includes(t.name)))),e.filters.assignees?.length&&(i=i.filter(t=>!!t.assignees?.length&&t.assignees.some(t=>e.filters.assignees.includes(t.id.toString())))),e.filters.due_date_range){const{start:t,end:a}=e.filters.due_date_range;i=i.filter(e=>{if(!e.due)return!1;const i=new Date(e.due).getTime();return!(t&&i<new Date(t).getTime())&&!(a&&i>new Date(a).getTime())})}return i}(e,this._config),this._config);this._displayedTasks=i;const a=wt(i,this._config.group_by||"none",this._config.group_field_id),o=!1!==this._config.add_button_overlay,s=this._config.add_button_position||"bottom-right",r=!o&&s.startsWith("top"),n=!o&&s.startsWith("bottom");return j`
        <ha-card>
        ...
        ${this._config.show_sort_controls?j`
          <div class="control-group">
            ...
            <select
              ...
              @change=${t=>{const e=t.target;this._config={...this._config,sort_by:e.value},vt(this,"config-changed",{config:this._config})}}
            >
            ...
            <button
              class="control-btn"
              @click=${()=>{const t="asc"===this._config.sort_order?"desc":"asc";this._config={...this._config,sort_order:t},vt(this,"config-changed",{config:this._config})}}
            ...
            <select
              ...
              @change=${t=>{const e=t.target;this._config={...this._config,group_by:e.value},vt(this,"config-changed",{config:this._config})}}
            >
    ...
    `}catch(t){return console.error("Error rendering ClickUp Todo Card editor:",t),j`
      ...
      `}}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i=e.configValue;if(!i)return;let a;if(void 0!==e.checked)a=e.checked;else{if(void 0===e.value)return;a=e.value}""===a&&"add_button_text"!==i&&(a=void 0),"fixed_height"===i&&void 0!==a&&(a=parseInt(a,10),isNaN(a)&&(a=void 0));const o={...this._config,[i]:a};"entity"===i&&setTimeout(()=>this._loadEntityData(),100),vt(this,"config-changed",{config:o})}_selectChanged(t){if(!this._config||!this.hass)return;const e=t.target;if(!e)return void console.log("No target element in select change event");const i=e.configValue;i?setTimeout(()=>{let t=e.value;if(null==t&&e&&"number"==typeof e.selected)try{const i=(e.querySelectorAll?Array.from(e.querySelectorAll("mwc-list-item")):[])[e.selected];i&&(t=i.value||i.getAttribute("value"))}catch(t){console.log("Error querying list items",t)}if(null==t)return void console.log("Could not determine dropdown value",{target:e,configValue:i,targetValue:e?.value,targetSelected:e?.selected});const a=""===t?void 0:t,o={...this._config,[i]:a};console.log("Updating config:",{configValue:i,value:a}),vt(this,"config-changed",{config:o}),this.requestUpdate(),this._config=o},50):console.log("No configValue on target",e)}_updateConfig(t,e){if(console.log("_updateConfig called:",{key:t,value:e,hasConfig:!!this._config}),!this._config)return;const i={...this._config,[t]:""===e?void 0:e};console.log("New config:",i),this._config=i,vt(this,"config-changed",{config:i}),console.log("Config updated and event fired")}_entityChanged(t){if(!this._config||t===this._config.entity)return;const e={...this._config,entity:t};this._config=e,this._loadEntityData(),vt(this,"config-changed",{config:e})}_isFieldVisible(t){return!(!this._config.visible_custom_fields||0===this._config.visible_custom_fields.length)&&this._config.visible_custom_fields.includes(t)}_customFieldChanged(t){const e=t.target,i=e.value,a=e.checked,o=this._config.visible_custom_fields||[];let s;s=a?[...o,i]:o.filter(t=>t!==i);const r={...this._config,visible_custom_fields:s.length>0?s:void 0};vt(this,"config-changed",{config:r})}_isStatusFiltered(t){return this._config.filters?.status?.includes(t)||!1}_statusFilterChanged(t){const e=t.target,i=e.value,a=e.checked,o=this._config.filters||{},s=o.status||[];let r;r=a?[...s,i]:s.filter(t=>t!==i);const n={...this._config,filters:{...o,status:r.length>0?r:void 0}};vt(this,"config-changed",{config:n})}_isPriorityFiltered(t){return this._config.filters?.priority?.includes(t)||!1}_priorityFilterChanged(t){const e=t.target,i=e.value,a="null"===i?null:parseInt(i),o=e.checked,s=this._config.filters||{},r=s.priority||[];let n;n=o?[...r,a]:r.filter(t=>t!==a);const l={...this._config,filters:{...s,priority:n.length>0?n:void 0}};vt(this,"config-changed",{config:l})}_isTagFiltered(t){return this._config.filters?.tags?.includes(t)||!1}_tagFilterChanged(t){const e=t.target,i=e.value,a=e.checked,o=this._config.filters||{},s=o.tags||[];let r;r=a?[...s,i]:s.filter(t=>t!==i);const n={...this._config,filters:{...o,tags:r.length>0?r:void 0}};vt(this,"config-changed",{config:n})}_isAssigneeFiltered(t){return this._config.filters?.assignees?.includes(t)||!1}_assigneeFilterChanged(t){const e=t.target,i=e.value,a=e.checked,o=this._config.filters||{},s=o.assignees||[];let r;r=a?[...s,i]:s.filter(t=>t!==i);const n={...this._config,filters:{...o,assignees:r.length>0?r:void 0}};vt(this,"config-changed",{config:n})}_dateRangeChanged(t,e){const i=this._config.filters||{},a={...i.due_date_range||{},[t]:e||void 0},o=a.start||a.end,s={...this._config,filters:{...i,due_date_range:o?a:void 0}};vt(this,"config-changed",{config:s})}static get styles(){return r`
      .card-config {
        padding: 16px;
      }
    ...
    `}}t([ht({attribute:!1})],Mt.prototype,"hass",void 0),t([ut()],Mt.prototype,"_config",void 0),t([ut()],Mt.prototype,"_tasks",void 0),t([ut()],Mt.prototype,"_helpers",void 0),customElements.get("clickup-todo-card-editor")||(customElements.define("clickup-todo-card-editor",Mt),console.log("ClickUp Todo Card Editor: Manually registered custom element"));var Vt=Object.freeze({__proto__:null,ClickUpTodoCardEditor:Mt});export{It as ClickUpTodoCard};
