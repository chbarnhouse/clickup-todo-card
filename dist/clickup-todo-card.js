...
`;async function Ft(t,e,i){try{return e.clickup_id?(await t.callService("clickup","update_task_status",{task_id:e.clickup_id,status:i}),{success:!0}):{success:!1,error:"Task does not have a ClickUp ID"}}catch(t){return console.error("Error updating task status:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}let Ot=class extends nt{constructor(){super(...arguments),this.value="",this.editing=!1,this.placeholder="Click to edit",this.required=!1,this.multiline=!1,this._tempValue="",this._error=""}static{this.styles=r`
  ...
  `}render(){return B`
    ...
    `}_addMetadataField(){if(!this._config.metadata_grid)return;const t={...this._config,metadata_grid:{...this._config.metadata_grid,fields:[...this._config.metadata_grid.fields||[],{type:"location"}]}};mt(this,"config-changed",{config:t})}_removeMetadataField(t){if(!this._config.metadata_grid)return;const e=[...this._config.metadata_grid.fields||[]];e.splice(t,1);const i={...this._config,metadata_grid:{...this._config.metadata_grid,fields:e}};mt(this,"config-changed",{config:i})}_moveMetadataField(t,e){if(!this._config.metadata_grid)return;const i=[...this._config.metadata_grid.fields||[]],a=t+e;if(a<0||a>=i.length)return;[i[t],i[a]]=[i[a],i[t]];const s={...this._config,metadata_grid:{...this._config.metadata_grid,fields:i}};mt(this,"config-changed",{config:s})}_metadataFieldPropertyChanged(t,e,i){if(!this._config.metadata_grid)return;const a=[...this._config.metadata_grid.fields||[]];if("type"===e)a[t]={...a[t],type:i};else if("span"===e)if(""===i){const{span:e,...i}=a[t];a[t]=i}else a[t]={...a[t],span:i};const s={...this._config,metadata_grid:{...this._config.metadata_grid,fields:a}};mt(this,"config-changed",{config:s})}static get styles(){return r`
      .card-config {
        display: flex;
        flex-direction: column;
        height: 100%;
